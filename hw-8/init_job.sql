...
insert into jobs.employees (employee_id, first_name, last_name, email, phone_integer, hire_date, job_id, salary, commission_pct, manager_id, department_id)
...
insert into jobs.departments (department_id, department_name, manager_id, location_id)
